      ...
      <div className="hidden lg:flex lg:w-2/5 bg-bg-surface relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          ...
          <p className="text-text-secondary mb-8">
            Join 12,000+ teams using NeuralDoc to unlock insights from their documents.
          </p>
          <div className="flex items-center gap-2">
            <div className="flex -space-x-2">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="w-8 h-8 rounded-full bg-accent-primary/20 border-2 border-bg-surface flex items-center justify-center text-xs text-accent-primary">
                  {String.fromCharCode(64 + i)}
                </div>
              ))}
            </div>
            <span className="text-sm text-text-muted">Join thousands of teams</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-text-secondary">Sign in to your NeuralDoc account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-border-default bg-bg-elevated accent-accent-primary" />
